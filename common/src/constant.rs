...
pub const STACK_BASE: VirtAddr =
    VirtAddr::new_truncate(STACK_LOWER.as_u64() + NUM_OF_PAGES_STACK.as_bytes().as_usize() as u64);
pub const STACK_LOWER: VirtAddr = VirtAddr::new_truncate(0xffff_ffff_bfff_0000);
